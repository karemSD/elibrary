      ...
      <form method="POST" action="/customers/{{$customer->id}}" >
        ...
        <div class="mb-6">
          ...
          <input required type="text" class="border border-gray-200 rounded p-2 w-full" name="address"
            placeholder="Example: Syris, Boston , etc" value="{{$customer->address}}" />
        ...
        <div class="mb-6">
          ...
          <input type="text" placeholder="Example.soso@gmail.com" class="border border-gray-200 rounded p-2 w-full" name="email" value="{{$customer->email}}" />
