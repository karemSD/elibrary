<x-layout>
  ...
  <li class="flex items-center justify-center bg-black text-white rounded-xl py-1 px-3 mr-2 text-xs">  published at: {{$listing->publish_year}}</li>
            </ul>
          <br>
...
@auth
                ...
                <a href="/addtocart/{{$listing->id}}/{{auth()->user()->id}}"
