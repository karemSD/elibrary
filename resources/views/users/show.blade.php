     ...
     <span class="text-danger" >  Name : </span>   {{$listing->first_name}} {{$listing->last_name}}
          ...
          <h3 class="text-2xl h4 pb-2 mb-4  border-bottom border-danger ">
            <span class="text-danger">Address :</span> {{$listing->address}}
              ...
              <h3 class="text-2xl  h4 pb-2 mb-4  border-bottom border-danger">
                <span class="text-danger" > Email :</span><a href="mailto:{{$listing->email}}">  {{$listing->email}}
                </a>
                  </h3>
                  <h3 class="text-2xl h4 pb-2 mb-4 border-bottom border-danger">
          ...
          <br>
          <span class="text-primary text-2xl h4 pb-2  " > <a href="/showbooksofcustomer/{{$listing->id}}">books that borrowed</a></span>
          ...
          <div>
            ...
            <br>
              <a href="/users/{{$listing->id}}/edit" target="_blank"
